...
public class Client {
    ...
    public static void main(String[] args) {
        try {
            /***** Bağlantı kurulumu *****/
            Connection conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/Proje",
                    "postgres", "12345");
            if (conn == null)
            ...
            while(true){
                ...
                if (rs.next() == false){
                    ...
                    if (sifre.equals(kullaniciSifre)){
                        ...
                        islemBirimi = MerkeziIslemBirimi.getInstance   ((IObserver) new Kullanici(kullaniciAdi, sifre));
                        break;
                    }
